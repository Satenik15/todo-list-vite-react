...
const NavBar = () => {
    ...
    return (
        <div className="fixed z-50 flex w-full items-center justify-between gap-3 bg-zinc-50 shadow-sm dark:bg-zinc-900 dark:shadow-black">
            <div className="flex justify-between bg-gray-900 py-5 px-10 w-full">
